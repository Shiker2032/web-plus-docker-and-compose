...
export const MainPage = ({ extraClass = "" }) => {
  ...
  useEffect(() => {
    Promise.all([getLastCards(), getTopCards(), getOwnWishes()]).then(([last, top, ownWishes]) => {
      setLastCards(last)
      setTopCards(top)
  ...
  console.log("ownWishes", ownWishes)
  ...
  return (
    <div className={`${styles.content} ${extraClass}`}>
      ...
      />
      <Route exact path={collectionsPath} render={() => <CollectionsView url={url} ownWishes={ownWishes} />} />
